...
public class Seminar {
  ...
  // for each kid in stuList... if there second choice is this and theyre not in any of the other lists that are sessions going on at the same time, add the person to the array list
